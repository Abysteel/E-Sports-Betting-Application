...
<h1 style="color:purple"><center>Mortal Kombat 11 Tournament</h1>
<p><center>Please choose your Winner<p>
  ...
  <body>
    ...
    <?php
      $arrX = array("SonicFox", "Dragon", "NinjaKilla", "A Foxy Grampa", "Deoxys243");
  ...
  <form action="" align="center" method="POST" value="result">
    ...
    <script>
    var snd = new Audio("finishhim.mp3");
    function myFunction() {
    confirm("You have successfully placed a bet!");
    }
    </script>
    <p><font color="purple">SonicFox</font><p>
      ...
      <!--Calculate the odds here-->
        <?php
            $sum="";
            if (isset($_POST['submit']) && "SonicFox" == $arrX[$randIndex5])
            {
  ...
  <form action="" align="center" method="POST">
    ...
    <p><font color="purple">Dragon</font><p>
      ...
      <?php
          $sum="";
          if (isset($_POST['submit2']) && "Dragon" == $arrX[$randIndex5])
          {
  ...
  <form action="" align="center" method="POST">
    ...
    <p><font color="purple">NinjaKilla</font><p>
      ...
      <?php
          $sum="";
          if (isset($_POST['submit3']) && "NinjaKilla" == $arrX[$randIndex5])
          {
  ...
  <form action="" align="center" method="POST">
    ...
    <p><font color="purple">A Foxy Grampa</font><p>
      ...
      <?php
          $sum="";
          if (isset($_POST['submit4']) && "A Foxy Grampa" == $arrX[$randIndex5])
          {
  ...
  <form action="" align="center" method="POST">
    ...
    <p><font color="purple">Deoxys243</font><p>
    ...
    ?>
      ...
      <?php
          $sum="";
          if (isset($_POST['submit5']) && "Deoxys243" == $arrX[$randIndex5])
          {
...
<img src="mortalkombat11.jpg" alt="" width="1950" height="800">
</html>
