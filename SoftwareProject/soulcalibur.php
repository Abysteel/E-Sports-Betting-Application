...
<h1 style="color:purple"><center>Soul Calibur 6 Tournament</h1>
<p><center>Please choose your Winner<p>
  ...
  <body>
    ...
    <?php
      $arrX = array("Keev", "RTD", "Xephukai", "LostProvidence", "Kayane");
  ...
  <form action="" method="POST" align="center" value="result">
    ...
    <p><font color="purple">Keev</font><p>
      ...
      <?php
          $sum="";
          if (isset($_POST['submit']) && "Keev" == $arrX[$randIndex5])
          {
  ...
  <form action="" align="center" method="POST">
    ...
    <p><font color="purple">RTD</font><p>
      ...
      <?php
          $sum="";
          if (isset($_POST['submit2']) && "RTD" == $arrX[$randIndex5])
          {
  ...
  <form action="" align="center" method="POST">
    ...
    <p><font color="purple">Xephukai</font><p>
      ...
      <?php
          $sum="";
          if (isset($_POST['submit3']) && "Xephukai" == $arrX[$randIndex5])
          {
  ...
  <form action="" align="center" method="POST">
    ...
    <p><font color="purple">LostProvidence</font><p>
      ...
      <?php
          $sum="";
          if (isset($_POST['submit4']) && "LostProvidence" == $arrX[$randIndex5])
          {
  ...
  <form action="" align="center" method="POST">
    ...
    <p><font color="purple">Kayane</font><p>
    ...
    ?>
      ...
      <?php
          $sum="";
          if (isset($_POST['submit5']) && "Kayane" == $arrX[$randIndex5])
          {
...
<img src="soulcalibur6.jpg" alt="" width="1950" height="800">
</html>
